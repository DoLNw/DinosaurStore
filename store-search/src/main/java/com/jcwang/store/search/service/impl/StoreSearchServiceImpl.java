package com.jcwang.store.search.service.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.jcwang.store.search.config.StoreElasticSearchConfig;
import com.jcwang.store.search.constant.EsConstant;
import com.jcwang.store.search.feign.ProductFeignService;
import com.jcwang.store.search.service.StoreSearchService;
import com.jcwang.store.search.vo.AttrResponseVo;
import com.jcwang.store.search.vo.BrandVo;
    ...
    private SearchResult buildSearchResult(SearchResponse response,SearchParam param) {
        ...
        if (param.getAttrs() != null && param.getAttrs().size() > 0) {
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                navVo.setLink("http://search.dinosaurstore.com/list.html?" + replace);
