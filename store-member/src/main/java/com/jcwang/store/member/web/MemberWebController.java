package com.jcwang.store.member.web;

import com.alibaba.fastjson.JSON;
import com.jcwang.store.member.feign.OrderFeignService;
...
public class MemberWebController {
    ...
    @GetMapping(value = "/test/memberOrder.html")
    public String testMemberOrderPage(@RequestParam(value = "pageNum",required = false,defaultValue = "0") Integer pageNum,
                                  Model model, HttpServletRequest request) {
